...
MAINTAINER Salman Ahmed <salman.great@gmail.com>

## Step 2
## Copy PECL helper file
...
## Step 5 (install PECL upload-progress php plugin)
RUN docker-php-pecl-install uploadprogress

## Step 6 (install PHP image-magic plugin)
